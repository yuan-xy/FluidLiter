...
cmake -S . -B $BUILD -DCMAKE_BUILD_TYPE=$BUILD #-DWITH_FLOAT=0
cmake --build $BUILD/
...
rm mono-test || true
gcc example/src/mono.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm -o mono-test
...
# gcc example/src/test2.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm -o test2
# valgrind --tool=massif --massif-out-file=massif_test2 ./test2


rm sfload_mem || true
gcc example/src/sfload_mem.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm -o sfload_mem
valgrind --tool=massif --massif-out-file=massif_sfload_mem ./sfload_mem mem.pcm
# massif-visualizer massif_sfload_mem

rm test3 || true
gcc example/src/test3.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm -o test3
./test3 example/sf_/GMGSx_1.sf2 test3.pcm
# ffmpeg -f s16le -ar 44100 -ac 1 -i test3.pcm test3.wav

gcc example/src/test4.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm -o test4
...
gcc example/src/test_u8.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm -o test_u8
./test_u8 example/sf_/GMGSx_1.sf2

gcc example/src/test_song.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm -o test_song
./test_song
./test_song u12
...
gcc example/src/test_conv.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm misc.o -o test_conv
./test_conv

gcc example/src/test_vel.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm misc.o -o test_vel
./test_vel


gcc example/src/test_fpe.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm misc.o -o test_fpe
./test_fpe

gcc example/src/test_fpe2.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm misc.o -rdynamic -o test_fpe2
./test_fpe2

gcc example/src/test_vel2.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm misc.o -o test_vel2
./test_vel2

#gcc example/src/test_441.c -g -Iinclude -Isrc -I$BUILD -L$BUILD -lfluidlite -lm -o test_441
#./test_441

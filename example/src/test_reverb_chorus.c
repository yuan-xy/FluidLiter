...
void assert_gen_Boomwhacker(fluid_synth_t *synth){
...
int main(){
    ...
    gen_song("song_no_reverb_no_chorus", synth, "example/sf_/GMGSx_1.sf2");
    ...
    gen_song("song_reverb_no_chorus", synth, "example/sf_/GMGSx_1.sf2");
    assert_gen_GMGSx_1(synth);
    delete_fluid_synth(synth);
